...
if( class_exists( 'Quick_Business_Website' ) ) {
	...
	$msg =  '<strong>' . __( 'You cannot activate a "Smartest Theme"', 'smartestb') . '</strong> ' . __( 'when using the <strong>Quick Business Website</strong> plugin because they clash. The Quick Business Website plugin is being deactivated now so you may use your <strong>Smartest Theme</strong>. Please go back and activate the theme again.', 'smartestb');
