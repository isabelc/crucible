...
function smar_nl2br(str)
{
	return str.replace(/(\r|\n|\r\n)/ig, "<br />");
}

function smar_br2nl(str)
{
...
BestInPlaceEditor.prototype = {
  ...
  sanitizeValue : function(s) {
    if (this.sanitize)
    {	
	  var news = smar_br2nl(s);
	  return jQuery.trim(smar_strip_tags(s));
    }
...
BestInPlaceEditor.forms = {
  ...
  "textarea" : {
    activateForm : function() {
	  ...
	  output += smar_br2nl(this.oldValue); /* fix for IE 8 issues */
